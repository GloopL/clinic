...
function getActivityIcon($activity_type) {
    switch($activity_type) {
        ...
        case 'consultation':
            return 'bi-heart-pulse-fill text-maroon';
        default:
...
<head>
    ...
    <title>Doctor Dashboard - BSU Clinic Record Management System</title>
            ...
            <div id="dashboard-content" class="tab-panel active">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-maroon">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600">Manage patient consultations, verify submissions, and issue medical certifications.</p>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="stats-card-2 text-white rounded-xl p-6 shadow-lg">
                        ...
                        <div class="mt-4">
                            <a href="#certification" onclick="switchTab('certification')" class="text-white text-sm font-medium hover:underline flex items-center">
                    ...
                    <div class="stats-card-3 text-white rounded-xl p-6 shadow-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold mt-2"><?php echo $total_consultations; ?></p>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                            <i class="bi bi-clock-history text-maroon"></i> Recent Patients (Medical Exams)
                        </h3>
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500 mb-2">No patients with medical examinations found</p>
                            <p class="text-gray-400 text-sm">Patient records will appear here after medical exams</p>
                        </div>
                    <?php endif; ?>
                </div>
...
<div id="patients-content" class="tab-panel hidden" style="display: none !important;">
    <div class="bg-white rounded-xl shadow-md p-0 overflow-hidden flex-1 h-full">
        ...
        <div id="patients-fallback" class="hidden h-full flex items-center justify-center" style="display: none;">
            ...
            <div id="analytics-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-maroon-light border border-maroon rounded-xl p-4">
                            <h3 class="text-sm font-semibold text-gray-600 mb-2">Consultations</h3>
                            <p class="text-3xl font-bold text-maroon"><?php echo $total_consultations; ?></p>
                        </div>
                        <div class="bg-maroon-light border border-maroon rounded-xl p-4">
                            <h3 class="text-sm font-semibold text-gray-600 mb-2">Pending Verification</h3>
                            <p class="text-3xl font-bold text-maroon"><?php echo $pending_verifications; ?></p>
                        </div>
                        <div class="bg-maroon-light border border-maroon rounded-xl p-4">
                            <h3 class="text-sm font-semibold text-gray-600 mb-2">For Certification</h3>
                            <p class="text-3xl font-bold text-maroon"><?php echo $for_certification_count; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4">Workflow Status</h3>
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">For Certification</span>
                                    <span class="font-semibold text-maroon"><?php echo $for_certification_count; ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Completed</span>
                                    <span class="font-semibold text-green-600"><?php echo $total_consultations; ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Today's Patients</span>
                                    <span class="font-semibold text-maroon"><?php echo count($recent_patients); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">This Month</span>
                                    <span class="font-semibold text-maroon"><?php echo min($total_consultations, 50); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Certifications This Month</span>
                                    <span class="font-semibold text-maroon"><?php echo min($for_certification_count, 30); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="profile-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <i class="bi bi-person-circle text-purple-600"></i> Doctor Profile
                    </h2>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium">Doctor</p>
                                    </div>
                                    <div>
                        ...
                        <div>
                            <div class="bg-gray-50 rounded-xl p-6 text-center">
                                ...
                                <p class="text-gray-600 text-sm mb-4">Doctor</p>
                                ...
                                <div class="space-y-3 text-left">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?php echo $total_consultations; ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Certifications:</span>
                                        <span class="font-medium"><?php echo $for_certification_count; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function switchTab(tabId) {
        ...
        // Save tab selection
        localStorage.setItem('doctorSelectedTab', tabId);
