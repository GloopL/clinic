  ...
  <main class="flex-grow max-w-7xl mx-auto px-4 py-8 w-full">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden mb-10">
      <div class="flex justify-between items-center px-4 py-3 red-orange-table-header text-white">
        <h3 class="font-semibold flex items-center gap-2"><i class="bi bi-shield-check"></i> Recent Medical Examinations</h3>
      ...
      <div class="p-4">
        <?php
        // Get 5 most recent medical examinations only for doctor
        $verifications = [];
        $query = "
            ...
            <tbody class="divide-y divide-orange-100">
              <?php if (count($verifications) > 0): ?>
                ...
                <tr class="red-orange-table-row hover:shadow transition-all duration-200">
                  ...
                  <td class="py-2 px-3">Medical Examination</td>
              ...
              <?php else: ?>
                <tr>
                  <td colspan="6" class="red-orange-gradient-alert text-orange-700 p-3 rounded text-center">No medical examinations found.</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden mb-8">
      ...
      <div class="p-6">
        <div class="red-orange-gradient-alert p-4 rounded-lg mb-6 border-l-4 border-orange-500">
          <h2 class="text-lg font-semibold text-orange-900">Welcome, <?php echo htmlspecialchars($greeting_display); ?>!</h2>
          <p class="text-orange-700">This is the Doctor Dashboard. Manage medical examinations and patient records.</p>
        </div>
