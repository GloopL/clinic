...
<head>
  ...
  <title>MSA Dashboard - BSU Clinic Records</title>
  ...
  <header class="red-orange-gradient text-white shadow-md">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
      ...
      <nav class="flex items-center gap-6">
        <a href="msa_dashboard.php" class="hover:text-yellow-200 flex items-center gap-1 font-semibold">
    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden mb-8">
      <div class="red-orange-gradient px-6 py-4">
        <h1 class="text-2xl font-bold text-white flex items-center gap-2">
          <i class="bi bi-speedometer2"></i> MSA Dashboard
        </h1>
      </div>
      <div class="p-6">
        <div class="red-orange-gradient-alert p-4 rounded-lg mb-6 border-l-4 border-orange-500">
          ...
          <p class="text-orange-700">This is the Medical Staff Assistant (MSA) Dashboard. Use the menu to access different modules.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div class="bg-white rounded-xl shadow-md p-6 text-center red-orange-gradient-card-light hover:shadow-lg transition-all">
            ...
            <a href="modules/qrcode/scan.php?from=msa" class="mt-4 inline-flex items-center gap-2 px-4 py-2 red-orange-gradient-button text-white rounded-lg font-semibold hover:shadow transition-all">
          ...
          <div class="bg-white rounded-xl shadow-md p-6 text-center red-orange-gradient-card-light hover:shadow-lg transition-all">
            ...
            <a href="modules/qrcode/generate.php?from=msa" class="mt-4 inline-flex items-center gap-2 px-4 py-2 red-orange-gradient-button text-white rounded-lg font-semibold hover:shadow transition-all">
