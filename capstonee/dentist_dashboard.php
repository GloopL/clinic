...
$recent_patients_query = "
    ...
    WHERE mr.record_type = 'dental_exam'
    GROUP BY p.id
...
$action = "Viewed Dentist Dashboard";
$stmt = $conn->prepare("
...
function generateDefaultAvatar($username) {
    ...
    if (empty($initials) && strlen($username) >= 2) {
        ...
        $initials = 'D'; // Default for dentist
    }
...
<head>
    ...
    <title>Dentist Dashboard - BSU Clinic Record Management System</title>
...
<body class="bg-maroon-light">
    ...
    <nav class="tab-nav" id="tabNav">
        ...
        <div class="p-6 border-b border-gray-800">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-gray-300 text-sm">
                    <span>Role:</span>
                    <span class="font-medium">Dentist</span>
                </div>
                <div class="flex justify-between text-gray-300 text-sm">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                            <i class="bi bi-clock-history text-maroon"></i> Recent Patients (Dental Exams)
                        </h3>
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-400 text-sm">Patient records will appear here after dental exams</p>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div id="profile-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <i class="bi bi-person-circle text-purple-600"></i> Dentist Profile
                    </h2>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium">Dentist</p>
                                    </div>
                                    <div>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 text-center">
                                ...
                                <div class="space-y-3 text-left">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?php echo $pending_verifications; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function switchTab(tabId) {
        ...
        // Save tab selection
        localStorage.setItem('dentistSelectedTab', tabId);
