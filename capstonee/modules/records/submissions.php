...
<head>
    ...
    <title>Consult - BSU Clinic</title>
...
<div class="min-h-screen py-6 px-4 pt-2">
    <div class="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-2xl font-bold text-maroon">Consult</h2>
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-xl font-semibold text-maroon">
                <?php 
                echo $type ? ucfirst(str_replace('_',' ', $type)) . ' Submissions' : 'All Submissions'; 
                ?>
                            ...
                            <tr class="maroon-table-row hover:shadow transition-all duration-200">
                                ...
                                <td class="py-3 px-4">
                                    <span class="px-2 py-1 rounded-full text-xs font-semibold
                                        <?php 
                                        echo $r['verification_status'] === 'verified' ? 'maroon-badge-verified' :
                                            ($r['verification_status'] === 'rejected' ? 'maroon-badge-rejected' : 'maroon-badge-pending'); 
                                        ?>">
                                        <?php echo strtoupper($r['verification_status']); ?>
                                    </span>
                                </td>
                                <td class="py-3 px-4">
                                    <?php
        ...
        <?php else: ?>
            ...
            <div class="text-center py-8">
                ...
                <p class="text-red-600 text-lg">No submissions found for consultation.</p>
                <p class="text-red-500 text-sm mt-2">
                    <?php if ($type): ?>
                        No <?php echo str_replace('_', ' ', $type); ?> submissions found.
                    <?php else: ?>
