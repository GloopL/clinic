...
// Get recent activities (if user_activities table exists)
$recent_activities = [];
...
<head>
    ...
    <title>Nurse Dashboard - BSU Clinic Record Management System</title>
...
<body class="bg-maroon-light">
        ...
        <div class="p-6 border-b border-gray-800">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm">Nurse</p>
                </div>
            </div>
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-gray-300 text-sm">
                    <span>Role:</span>
                    <span class="font-medium">Nurse</span>
                </div>
                <div class="flex justify-between text-gray-300 text-sm">
        ...
        <div class="main-content p-6">
            ...
            <div id="dashboard-content" class="tab-panel active">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-maroon">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-800 mb-2">Welcome, Nurse <?php echo htmlspecialchars($display_name); ?>!</h2>
                            <p class="text-gray-600">Manage patient records, verify submissions, and monitor clinic activities.</p>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <!-- For Consultation Card -->
                    <div class="stats-card-2 text-white rounded-xl p-6 shadow-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm opacity-90">For Consultation</p>
                                <p class="text-3xl font-bold mt-2"><?php echo $total_records; ?></p>
                            </div>
                            <i class="bi bi-clipboard-check text-4xl opacity-80"></i>
                        </div>
                        <div class="mt-4">
                            <a href="#submissions" onclick="switchTab('submissions')" class="text-white text-sm font-medium hover:underline flex items-center">
                                View Submissions <i class="bi bi-arrow-right ml-1"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="stats-card-4 text-white rounded-xl p-6 shadow-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm opacity-90">Total Forms</p>
                                <p class="text-3xl font-bold mt-2"><?php echo $total_history_forms + $total_dental_exams + $total_medical_exams; ?></p>
                            </div>
                            <i class="bi bi-file-earmark-text text-4xl opacity-80"></i>
                        </div>
                        <div class="mt-4">
                            <a href="#analytics" onclick="switchTab('analytics')" class="text-white text-sm font-medium hover:underline flex items-center">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                            <i class="bi bi-clock-history text-maroon"></i> Recent Patients
                        </h3>
                        <a href="#patients" onclick="switchTab('patients')" class="text-maroon hover:text-maroon-dark text-sm font-medium flex items-center">
                            ...
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <tr class="maroon-table-row hover:shadow transition-all duration-200">
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($patient['student_id']); ?></td>
                                        <td class="py-3 px-4 font-medium"><?php echo htmlspecialchars($patient['last_name']) . ', ' . htmlspecialchars($patient['first_name']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($patient['program'] ?? 'N/A'); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($patient['year_level'] ?? 'N/A'); ?></td>
                                        <td class="py-3 px-4"><?php echo $patient['last_visit'] ? htmlspecialchars($patient['last_visit']) : 'No visits'; ?></td>
                                        <td class="py-3 px-4">
                                            <a href="modules/records/view_patient.php?id=<?php echo $patient['id']; ?>" class="inline-flex items-center gap-1 px-3 py-1 maroon-badge rounded hover:shadow text-xs font-semibold transition-all">
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500 mb-2">No patients found in the system</p>
                            <p class="text-gray-400 text-sm">Patient records will appear here</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="modules/records/patients.php" class="bg-maroon-light border border-maroon rounded-lg p-4 hover:bg-red-50 transition-all duration-200 flex items-center gap-3">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-800">Add New Patient</h4>
                        ...
                        <a href="modules/analytics/analytics_dashboard.php" class="bg-maroon-light border border-maroon rounded-lg p-4 hover:bg-red-50 transition-all duration-200 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Clinic statistics</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div id="submissions-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <p class="text-gray-600 mb-6">Verify and manage submitted forms</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <a href="modules/records/submissions.php?type=history_form" class="bg-maroon-light border border-maroon rounded-xl p-6 shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02]">
                            <div class="flex items-center justify-center mb-4">
                                <i class="bi bi-clipboard2-pulse-fill text-4xl text-maroon"></i>
                            </div>
                            <h3 class="text-lg font-semibold tracking-tight text-center mb-2 text-gray-800">History Forms</h3>
                            <p class="text-2xl font-bold text-center text-maroon"><?php echo $total_history_forms; ?></p>
                            <p class="text-sm opacity-90 text-center text-gray-600">Medical History for Athletes</p>
                        </a>

                        <a href="modules/records/submissions.php?type=dental_exam" class="bg-maroon-light border border-maroon rounded-xl p-6 shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02]">
                            <div class="flex items-center justify-center mb-4">
                                <i class="fas fa-tooth text-4xl text-maroon"></i>
                            </div>
                            <h3 class="text-lg font-semibold tracking-tight text-center mb-2 text-gray-800">Dental Exams</h3>
                            <p class="text-2xl font-bold text-center text-maroon"><?php echo $total_dental_exams; ?></p>
                            <p class="text-sm opacity-90 text-center text-gray-600">Dental Examination Forms</p>
                        </a>

                        <a href="modules/records/submissions.php?type=medical_exam" class="bg-maroon-light border border-maroon rounded-xl p-6 shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02]">
                            <div class="flex items-center justify-center mb-4">
                                <i class="bi bi-heart-pulse text-4xl text-maroon"></i>
                            </div>
                            <h3 class="text-lg font-semibold tracking-tight text-center mb-2 text-gray-800">Medical Exams</h3>
                            <p class="text-2xl font-bold text-center text-maroon"><?php echo $total_medical_exams; ?></p>
                            <p class="text-sm opacity-90 text-center text-gray-600">Pre-Employment/OJT Exams</p>
                        </a>
                    </div>
            ...
            <div id="analytics-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-maroon-light border border-maroon rounded-xl p-4">
                            <h3 class="text-sm font-semibold text-gray-600 mb-2">Verified Forms</h3>
                            <p class="text-3xl font-bold text-maroon"><?php echo $total_records; ?></p>
                        </div>
                        <div class="bg-maroon-light border border-maroon rounded-xl p-4">
                            <h3 class="text-sm font-semibold text-gray-600 mb-2">Pending Forms</h3>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-orange-600"><?php echo $pending_verifications; ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Verified</span>
                                    <span class="font-semibold text-green-600"><?php echo $total_records; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="profile-content" class="tab-panel hidden">
                <div class="bg-white rounded-xl shadow-md p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <i class="bi bi-person-circle text-purple-600"></i> Nurse Profile
                    </h2>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium">Nurse</p>
                                    </div>
                                    <div>
                        ...
                        <div>
                            <div class="bg-gray-50 rounded-xl p-6 text-center">
                                ...
                                <p class="text-gray-600 text-sm mb-4">Nurse</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Load saved tab
        const savedTab = localStorage.getItem('nurseSelectedTab') || 'dashboard';
        switchTab(savedTab);
