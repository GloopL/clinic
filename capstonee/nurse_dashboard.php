      ...
      <div class="p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          ...
          <div class="stats-card-2 text-white rounded-xl p-6 flex flex-col items-center shadow-md hover:shadow-lg transition-all">
            ...
            <h3 class="text-3xl font-bold"><?php echo $total_records; ?></h3>
            <p>For Consultation</p>
            <a href="modules/records/submissions.php" class="mt-4 bg-white text-orange-600 px-3 py-1 rounded-lg font-semibold text-sm hover:bg-orange-50 transition">View All</a>
          </div>
